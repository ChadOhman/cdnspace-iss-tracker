      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: 16 }}>
          <div style={{ fontSize: 10, color: "#8892a4", letterSpacing: "0.08em", marginBottom: 8 }}>
            NASA ISS LIVE STREAM — HD EARTH VIEWING
          </div>
          ...
          <div style={{ marginTop: 8, fontSize: 9, color: "#4a5568", letterSpacing: "0.06em" }}>
            Stream courtesy of NASA. Video may show crew activity, Earth views, or a &quot;Be Right Back&quot; screen during night passes.
          </div>
        </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              {activeEvent.scheduledStart && (
                <div style={{ fontSize: 9, color: "#8892a4" }}>
                  START: {new Date(activeEvent.scheduledStart).toUTCString()}
                </div>
              )}
              {activeEvent.scheduledEnd && (
                <div style={{ fontSize: 9, color: "#8892a4" }}>
                  END: {new Date(activeEvent.scheduledEnd).toUTCString()}
                </div>
              )}
            </div>
          ) : (
            <div style={{ fontSize: 10, color: "#4a5568", lineHeight: 1.6 }}>
              No active event at this time. Check back during scheduled EVAs, dockings, or crew activities.
            </div>
          )}

          {/* Info section */}
          <div style={{ marginTop: "auto", fontSize: 9, color: "#4a5568", lineHeight: 1.6, borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: 10 }}>
            The ISS completes one orbit every ~92 minutes at 28,000 km/h. Earth views appear during daylight passes.
          </div>
        </div>
      </div>
    </div>
